...
// -------------------------------------- control finding----------------------//
void Task::Control_AltInt(int trNum) {  //поиск управления методом построения Альтенированного интеграла Понтрягина
...
// -------------------------------------- control finding----------------------//
void Task::Control_R1(int trNum) { //поиск управления в условиях достумсности информации только о расстоянии до цели
	TNetF c(PP.m(), perfomance, steps), x_Net(c);
...
// -------------------------------------- control finding----------------------//
void Task::Control_R2(int trNum) { //поиск управления в условиях достумсности информации только о расстоянии до цели
	TNetF c(PP.m(), perfomance, steps), x_Net(c);
	TNetF tmpPNet(PP.m(), perfomance, steps), tmpQNet(PP.m(), perfomance, steps);
	unsigned long i, j, k, m;
	long Ind = 0;
...
// -------------------------------------- control finding----------------------//
void Task::Control_Pontryagin(int trNum) {  //поиск управления первым методом преследования Понтрягина
	TNetF c(PP.m(), perfomance, steps), x_Net(c);
	TNetF tmpPNet(*cP), tmpQNet(*cQ);
	unsigned long i, j, k, m;
	long Ind = 0;
